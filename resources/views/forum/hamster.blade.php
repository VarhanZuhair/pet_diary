...
<body class="">
    ...
    <div class="container">
        <div class="row">
            <div class="col-2">
                <img src="/image/forum/hamster.svg" alt="" srcset="" width="200px">
            </div>
            <div class="col-8 position-relative">
                <h3><b class="position-absolute top-50 start-0 translate-middle-y">HAMSTER FORUM</b></h3>
            </div>
            <div class="col-2 position-relative">
                <div class="row">
                    <a href="{{ url('/forum/hamster/post') }}" class="btn warna-oren berubah-warna position-absolute bottom-0 start-50 translate-middle-x">Add New Post</a>
                </div>
            </div>
        </div>
    </div>
