...
<body class="">
    ...
    <div class="container">
        <div class="row my-5">
            <form action="{{ url('forumDelete') }}" method="post">
                @csrf
                <div class="row g-5">
                    <div class="col-6">
                        <h3>Are you sure wants to delete this Post?</h3>
                    </div>
                    <div class="col-3">
                        <div class="row">
                            <a href="{{ url('forum', $forum->category) }}" class="btn btn-secondary">No</a>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="row">
                    ...
                    <div class="mb-3">
                    <input class="form-control invisible" id="post_id" name="post_id" rows="3" readonly value="{{ $forum->post_id }}">
                    </div>
                    <div class="mb-3">
                        <input class="form-control invisible" id="category" name="category" rows="3" readonly value="{{ $forum->category }}">
                    </div>
                </div>
            </form>
        </div>
