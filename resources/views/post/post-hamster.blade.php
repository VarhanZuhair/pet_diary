...
<body class="">
    ...
    <div class="container">
        <form action="{{ url('forum/hamster/store') }}" method="POST">
            @csrf
            <div class="row my-5">
                <h3>ADD TOPIC IN <span class="text-warning">HAMSTER</span></h3>
            </div>
            <div class="row">
                ...
                <div class="row d-flex justify-content-end">
                    ...
                    <div class="col-3">
                        <div class="row">
                            <div class="col-6">
                                <div class="row mx-1">
                                    <a href="{{ url('/forum/hamster') }}" class="btn btn-secondary">BACK</a>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="row mx-1">
                ...
                <div class="form-floating my-3">
                    <input type="text" class="form-control invisible" id="category" name="category" placeholder="" readonly value="hamster">
                    <label for="floatingInput" class="ps-4 fs-5 invisible">Category</label>
                </div>
            </div>
        </form>
