...
<body class="">
    ...
    <div class="container">
        <form action="{{ url('forumUpdate') }}" method="POST">
            @csrf
            <div class="row my-5">
                <h3>EDIT TOPIC IN <span class="text-warning">{{ $forum->category }}</span></h3>
            </div>
            <div class="row">
                ...
                <div class="form-floating my-3">
                    <textarea type="text" class="form-control" id="description" name="description" placeholder="" style="height: 200px" required>{{ $forum->description }}</textarea>
                ...
                <div class="row d-flex justify-content-end">
                    ...
                    <div class="col-3">
                        <div class="row">
                            <div class="col-6">
                                <div class="row mx-1">
                                    <a href="{{ url('/forum') }}" class="btn btn-secondary">BACK</a>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="row mx-1">
                                    <button type="submit" class="btn btn-primary" oncilick="alert('Forum has been updated')">SUBMIT</button>
                                </div>
                            </div>
                        </div>
                    </div>
